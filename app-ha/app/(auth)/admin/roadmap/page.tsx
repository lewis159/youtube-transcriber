...
const ROADMAP: RoadmapItem[] = [
  ...
  // Pre-launch
  { id: 7,  title: 'Stripe integration',                      description: 'Subscription checkout flow + Stripe webhook handler for tier upgrades (Starter → Pro → Studio → Enterprise).',                                                   status: 'pending',  priority: 'high',         category: 'prelaunch', updatedAt: '2026-06-14' },
  ...
  { id: 26, title: 'Container start/stop/pause controls',      description: 'Admin panel can control project containers (start/stop/pause) with a typed confirmation phrase before destructive actions execute.',                                  status: 'completed', priority: 'medium',       category: 'admin',     updatedAt: '2026-06-15' },
  { id: 27, title: 'Admin Security findings panel',            description: '/admin/security dashboard surfacing all 28 security review findings with live fix status, severity breakdown, and a priority action plan.',                          status: 'completed', priority: 'medium',       category: 'admin',     updatedAt: '2026-06-15' },
  { id: 28, title: 'Google Analytics 4',                       description: 'gtag.js integrated via NEXT_PUBLIC_GA_ID with IP anonymisation, gated behind the env var so it only loads when configured.',                                          status: 'in_progress', priority: 'medium',     category: 'prelaunch', updatedAt: '2026-06-15' },
  { id: 29, title: 'v3 — Standalone support portal',           description: 'Extract support tooling (user mgmt, support notes, billing actions, read-only impersonation) into its own Next.js app with shared global_admin auth. Do not start until v2 ships.', status: 'future', priority: 'nice_to_have', category: 'v2',        updatedAt: '2026-06-15' },
]
